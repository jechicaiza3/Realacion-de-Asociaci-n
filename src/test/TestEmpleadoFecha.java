...
public class TestEmpleadoFecha {
    ...
    public static void ingresarDatos() {
        ...
        for (int i = 0; i < emp.length; i++) {
            ...
            System.out.println("Nombre deL Trabajador: " + emp[i].getNombre());
    ...
    public static void llenaEmpresa(Empleados emp[]) {
        ...
        for (int i = 0; i < emp.length; i++) {
            ...
            System.out.println("Introdusca Año:");
            anio = datos.nextInt();
            System.out.println("Introdusca Mes:");
            mes = datos.nextInt();
            System.out.println("Introdusca Dia:");
            dia = datos.nextInt();
